...
def mundoplus_guide(params):
    plugintools.log("[PalcoTV 0.3.3].Mundoplus.tv "+repr(params))
...
def mundoplus1(params):
    plugintools.log("[PalcoTV 0.3.3].Mundoplus.tv búsqueda "+repr(params))
...
def gethttp_referer_headers(url,referer):
    plugintools.log("PalcoTV 0.3.3 Gethttp_referer_headers "+url)
    request_headers=[]
