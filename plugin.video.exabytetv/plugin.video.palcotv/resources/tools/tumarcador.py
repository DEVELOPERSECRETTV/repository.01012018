...
parser="[COLOR skyblue][B]TuMarcador  [/COLOR]"
autor="[COLOR gold][B][I]      **** by LReylist ****[/I][/B][/COLOR]"
...
#guia = "http://palcomax.ddns.net/owncloud/index.php/s/8qb00jh5cv3Xheo/download"
guia = "http://pastebin.com/raw/24d2JUbU"
...
def tumarcador0(params):
	###################################################################### DMO ######################################################################
	mi_version = ["2016","11","21"]  # OJO!! Cambiar la Version, por supuesto... AQUI Y EN EL FICHERO DE LA NUBE
