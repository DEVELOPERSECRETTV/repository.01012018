...
def arena_dmax0(params):
	...
	plugintools.add_item(action="",url="",title="[COLOR blue][B]                 ArenaVision[/B]   [I]"+version+"[/I][/COLOR][COLOR gold][I]      *** By LReylist ***[/I][/COLOR]",thumbnail="http://s15.postimg.org/bicwnygez/ARENAVISION.jpg",fanart=fanart,folder=False,isPlayable=False)
...
def arenazaping(params):
	...
	plugintools.add_item(action="",url="",title="[COLOR blue][B]   Zapping   ArenaVision[/B]   [I]"+version+"[/I][/COLOR][COLOR yellow][I]    **** byDarioMO ****[/I][/COLOR]",thumbnail=thumbnail,fanart=fanart,folder=False,isPlayable=False)
	plugintools.add_item(action="",url="",title="",thumbnail=thumbnail, fanart=fanart, folder=False, isPlayable=False)
