# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Linker Descargacineclasico.net para PalcoTV
...
import plugintools, requests, base64
...
thumbnail = "https://www.cubbyusercontent.com/pl/Cineclasico_logo.png/_c70b9b9a4d5840a6a43cc350d4460e4e"
fanart = "https://www.cubbyusercontent.com/pl/Cineclasico_Fanart.jpg/_969c7f795d04441597d11f0653579282"
...
def cineclasico_linker0(params):
    ...
    for item in film:
        ...
        ####################################### Control for Library #########################################
            ...
            titlefull = '[COLOR white]'+server.title()+' '+'[/COLOR][COLOR lightyellow][I]['+lang.replace("[I]", "").replace("[/I]", "").replace("[", "").replace("]", "").strip()+'] [/COLOR][COLOR lightblue]['+quality+'] [/COLOR][COLOR gold][HDFull][/I][/COLOR]'
            url_list.append(url);option_list.append(titlefull)
        #####################################################################################################
